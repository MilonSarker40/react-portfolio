              ...
              <div className='row'>
                ...
                <div className='col-3'>
                  <div className='ftr-menu-2 ftr-menu-3 ftr-title'>
                    ...
                    <ul className='clearfix reset-list'>
                      <li><Link><i class="ri-map-pin-fill"></i> Bosila, Mohammadpur Dhaka, Bangladesh</Link></li>
                      <li><Link><i class="ri-phone-fill"></i>  +8801515619787</Link></li>
                      <li><Link><i class="ri-phone-fill"></i>  +8801746972440</Link></li>
                      <li><Link><i class="ri-mail-line"></i> milonsarker414@gmail.com</Link></li>
                    </ul>
                  </div>
                </div>
                <div className='col-3'>
           ...
           <div className='container'>
             <div className='row'>
                <div className='col-12'>
                  <p>Copyright © 2021 Milon All Rights Reserved.</p>
                </div>
             </div>
           </div>
         </div>
